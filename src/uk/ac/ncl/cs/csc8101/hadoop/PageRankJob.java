...
//    	boolean isCompleted = runXmlParsing("input/HadoopPageRank/wiki", "output/HadoopPageRank/result");
...
//            isCompleted = runRankCalculator(inPath, "output/HadoopPageRank/result");
            if (!isCompleted) return 1;
        }
